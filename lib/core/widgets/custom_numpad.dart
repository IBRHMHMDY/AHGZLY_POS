...
// 🪄 ويدجت مخصصة لعرض النقاط الخاصة بالرمز السري
...
// 🪄 ويدجت مخصصة للوحة المفاتيح لتوحيد الـ UI في النظام (DRY)
  ...
  Widget build(BuildContext context) {
    return GridView.count(
      ...
      children: [
        ...
        isLoading 
            ? _buildLoadingBtn() 
            : _buildActionBtn(Icons.lock_open_rounded, onSubmitPressed, Colors.teal.shade100, Colors.teal.shade800),
      ],
    );
  }
