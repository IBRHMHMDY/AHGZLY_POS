...
class ItemData extends DataClass implements Insertable<ItemData> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, categoryId, name, price, costPrice, createdAt, updatedAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is ItemData &&
...
class $ZonesTable extends Zones with TableInfo<$ZonesTable, ZoneData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
...
class ZoneData extends DataClass implements Insertable<ZoneData> {
  final int id;
  final String name;
  const ZoneData({required this.id, required this.name});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['id'] = Variable<int>(id);
  ...
  ZonesCompanion toCompanion(bool nullToAbsent) {
    return ZonesCompanion(id: Value(id), name: Value(name));
  }

  factory ZoneData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  ZoneData copyWith({int? id, String? name}) =>
      ZoneData(id: id ?? this.id, name: name ?? this.name);
  ZoneData copyWithCompanion(ZonesCompanion data) {
    return ZoneData(
      id: data.id.present ? data.id.value : this.id,
      name: data.name.present ? data.name.value : this.name,
    );
...
class ZonesCompanion extends UpdateCompanion<ZoneData> {
  final Value<int> id;
  final Value<String> name;
  ...
  ZonesCompanion.insert({this.id = const Value.absent(), required String name})
    : name = Value(name);
  ...
  ZonesCompanion copyWith({Value<int>? id, Value<String>? name}) {
    return ZonesCompanion(id: id ?? this.id, name: name ?? this.name);
  }
...
class $RestaurantTablesTable extends RestaurantTables
    with TableInfo<$RestaurantTablesTable, RestaurantTableData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
...
class RestaurantTableData extends DataClass
  ...
  factory RestaurantTableData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  RestaurantTableData copyWithCompanion(RestaurantTablesCompanion data) {
    return RestaurantTableData(
      id: data.id.present ? data.id.value : this.id,
  ...
  @override
  int get hashCode => Object.hash(id, zoneId, tableNumber, capacity, status);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class RestaurantTablesCompanion extends UpdateCompanion<RestaurantTableData> {
  final Value<int> id;
...
class $PaymentMethodsTable extends PaymentMethods
    with TableInfo<$PaymentMethodsTable, PaymentMethodData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<PaymentMethodData> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  PaymentMethodData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
...
class PaymentMethodData extends DataClass
    implements Insertable<PaymentMethodData> {
  final int id;
  final String name;
  final bool isActive;
  ...
  factory PaymentMethodData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  PaymentMethodData copyWith({int? id, String? name, bool? isActive}) =>
      PaymentMethodData(
        id: id ?? this.id,
        name: name ?? this.name,
        isActive: isActive ?? this.isActive,
      );
  PaymentMethodData copyWithCompanion(PaymentMethodsCompanion data) {
    return PaymentMethodData(
      id: data.id.present ? data.id.value : this.id,
      name: data.name.present ? data.name.value : this.name,
      isActive: data.isActive.present ? data.isActive.value : this.isActive,
  ...
  @override
  String toString() {
    return (StringBuffer('PaymentMethodData(')
          ..write('id: $id, ')
          ..write('name: $name, ')
          ..write('isActive: $isActive')
          ..write(')'))
...
class PaymentMethodsCompanion extends UpdateCompanion<PaymentMethodData> {
  final Value<int> id;
  final Value<String> name;
  final Value<bool> isActive;
  ...
  static Insertable<PaymentMethodData> custom({
    Expression<int>? id,
    Expression<String>? name,
    Expression<bool>? isActive,
  }) {
...
class $ItemVariantsTable extends ItemVariants
  ...
  @override
  List<GeneratedColumn> get $columns => [id, itemId, name, price, costPrice];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<ItemVariantData> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  ItemVariantData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
...
class ItemVariantData extends DataClass implements Insertable<ItemVariantData> {
  final int id;
  final int itemId;
  final String name;
  final int price;
  final int costPrice;
  const ItemVariantData({
    required this.id,
  ...
  factory ItemVariantData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  ItemVariantData copyWithCompanion(ItemVariantsCompanion data) {
    return ItemVariantData(
      id: data.id.present ? data.id.value : this.id,
  ...
  @override
  String toString() {
    return (StringBuffer('ItemVariantData(')
          ..write('id: $id, ')
          ..write('itemId: $itemId, ')
          ..write('name: $name, ')
          ..write('price: $price, ')
  ...
  @override
  int get hashCode => Object.hash(id, itemId, name, price, costPrice);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is ItemVariantData &&
          other.id == this.id &&
...
class ItemVariantsCompanion extends UpdateCompanion<ItemVariantData> {
  final Value<int> id;
  ...
  ItemVariantsCompanion.insert({
    ...
    this.costPrice = const Value.absent(),
       ...
       name = Value(name),
       price = Value(price);
  static Insertable<ItemVariantData> custom({
    Expression<int>? id,
...
class $AddonsTable extends Addons with TableInfo<$AddonsTable, AddonData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  @override
  List<GeneratedColumn> get $columns => [id, name, price, costPrice];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  AddonData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return AddonData(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
...
class AddonData extends DataClass implements Insertable<AddonData> {
  final int id;
  final String name;
  final int price;
  final int costPrice;
  ...
  AddonData copyWith({int? id, String? name, int? price, int? costPrice}) =>
      AddonData(
        id: id ?? this.id,
        name: name ?? this.name,
        price: price ?? this.price,
  ...
  AddonData copyWithCompanion(AddonsCompanion data) {
    return AddonData(
      id: data.id.present ? data.id.value : this.id,
      name: data.name.present ? data.name.value : this.name,
      price: data.price.present ? data.price.value : this.price,
  ...
  @override
  int get hashCode => Object.hash(id, name, price, costPrice);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is AddonData &&
...
class AddonsCompanion extends UpdateCompanion<AddonData> {
  final Value<int> id;
  final Value<String> name;
  final Value<int> price;
  final Value<int> costPrice;
  ...
  AddonsCompanion.insert({
    ...
    this.costPrice = const Value.absent(),
       ...
       price = Value(price);
  static Insertable<AddonData> custom({
    Expression<int>? id,
    Expression<String>? name,
    Expression<int>? price,
    Expression<int>? costPrice,
...
class InventoryItemData extends DataClass
  ...
  @override
  int get hashCode => Object.hash(id, name, unit, stockQuantity, costPerUnit);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class $PurchaseInvoicesTable extends PurchaseInvoices
    with TableInfo<$PurchaseInvoicesTable, PurchaseInvoiceData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  @override
  late final GeneratedColumnWithTypeConverter<DateTime, String> invoiceDate =
      GeneratedColumn<String>(
        'invoice_date',
        aliasedName,
        false,
        type: DriftSqlType.string,
        requiredDuringInsert: true,
      ).withConverter<DateTime>($PurchaseInvoicesTable.$converterinvoiceDate);
  static const VerificationMeta _notesMeta = const VerificationMeta('notes');
  @override
  late final GeneratedColumn<String> notes = GeneratedColumn<String>(
    'notes',
  ...
  late final GeneratedColumnWithTypeConverter<DateTime, String> createdAt =
      GeneratedColumn<String>(
        ...
        type: DriftSqlType.string,
        requiredDuringInsert: true,
      ).withConverter<DateTime>($PurchaseInvoicesTable.$convertercreatedAt);
  @override
  List<GeneratedColumn> get $columns => [
    id,
    supplierId,
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<PurchaseInvoiceData> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  PurchaseInvoiceData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return PurchaseInvoiceData(
      ...
      invoiceDate: $PurchaseInvoicesTable.$converterinvoiceDate.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.string,
      ...
      createdAt: $PurchaseInvoicesTable.$convertercreatedAt.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.string,
          data['${effectivePrefix}created_at'],
        )!,
  ...
  static TypeConverter<DateTime, String> $converterinvoiceDate =
      const DateTimeConverter();
  static TypeConverter<DateTime, String> $convertercreatedAt =
      const DateTimeConverter();
}

class PurchaseInvoiceData extends DataClass
    implements Insertable<PurchaseInvoiceData> {
  final int id;
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    {
      map['invoice_date'] = Variable<String>(
        $PurchaseInvoicesTable.$converterinvoiceDate.toSql(invoiceDate),
      );
    }
    if (!nullToAbsent || notes != null) {
      map['notes'] = Variable<String>(notes);
    ...
    {
      map['created_at'] = Variable<String>(
        $PurchaseInvoicesTable.$convertercreatedAt.toSql(createdAt),
      );
    }
    return map;
  }
  ...
  PurchaseInvoiceData copyWithCompanion(PurchaseInvoicesCompanion data) {
    return PurchaseInvoiceData(
      id: data.id.present ? data.id.value : this.id,
  ...
  @override
  String toString() {
    return (StringBuffer('PurchaseInvoiceData(')
          ..write('id: $id, ')
...
class PurchaseInvoicesCompanion extends UpdateCompanion<PurchaseInvoiceData> {
  final Value<int> id;
  ...
  PurchaseInvoicesCompanion.insert({
    ...
    required DateTime createdAt,
       ...
       invoiceDate = Value(invoiceDate),
       createdAt = Value(createdAt);
  static Insertable<PurchaseInvoiceData> custom({
    Expression<int>? id,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (invoiceDate.present) {
      map['invoice_date'] = Variable<String>(
        $PurchaseInvoicesTable.$converterinvoiceDate.toSql(invoiceDate.value),
      );
    }
    if (notes.present) {
      map['notes'] = Variable<String>(notes.value);
    ...
    if (createdAt.present) {
      map['created_at'] = Variable<String>(
        $PurchaseInvoicesTable.$convertercreatedAt.toSql(createdAt.value),
      );
    }
    return map;
  }
...
class $PurchaseInvoiceItemsTable extends PurchaseInvoiceItems
    with TableInfo<$PurchaseInvoiceItemsTable, PurchaseInvoiceItemData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<PurchaseInvoiceItemData> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
...
class PurchaseInvoiceItemData extends DataClass
    implements Insertable<PurchaseInvoiceItemData> {
  final int id;
  final int invoiceId;
  final int inventoryItemId;
  ...
  factory PurchaseInvoiceItemData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  PurchaseInvoiceItemData copyWith({
    int? id,
    int? invoiceId,
    int? inventoryItemId,
    double? quantity,
  ...
  PurchaseInvoiceItemData copyWithCompanion(
    PurchaseInvoiceItemsCompanion data,
  ) {
    return PurchaseInvoiceItemData(
      id: data.id.present ? data.id.value : this.id,
  ...
  @override
  String toString() {
    return (StringBuffer('PurchaseInvoiceItemData(')
          ..write('id: $id, ')
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is PurchaseInvoiceItemData &&
          other.id == this.id &&
...
class PurchaseInvoiceItemsCompanion
    extends UpdateCompanion<PurchaseInvoiceItemData> {
  final Value<int> id;
  ...
  PurchaseInvoiceItemsCompanion.insert({
    ...
    required int totalCost,
       ...
       unitCost = Value(unitCost),
       totalCost = Value(totalCost);
  static Insertable<PurchaseInvoiceItemData> custom({
    Expression<int>? id,
...
class $InventoryTransactionsTable extends InventoryTransactions
    with TableInfo<$InventoryTransactionsTable, InventoryTransactionData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  late final GeneratedColumnWithTypeConverter<DateTime, String> createdAt =
      GeneratedColumn<String>(
        ...
        $InventoryTransactionsTable.$convertercreatedAt,
      );
  @override
  List<GeneratedColumn> get $columns => [
    id,
  ...
  InventoryTransactionData map(
    ...
    return InventoryTransactionData(
      ...
      createdAt: $InventoryTransactionsTable.$convertercreatedAt.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.string,
          data['${effectivePrefix}created_at'],
        )!,
...
class InventoryTransactionData extends DataClass
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    {
      map['created_at'] = Variable<String>(
        $InventoryTransactionsTable.$convertercreatedAt.toSql(createdAt),
      );
    }
    return map;
  }
...
class InventoryTransactionsCompanion
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (createdAt.present) {
      map['created_at'] = Variable<String>(
        $InventoryTransactionsTable.$convertercreatedAt.toSql(createdAt.value),
      );
    }
    return map;
  }
...
final class $$ItemsTableReferences
  ...
  _itemVariantsRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.itemVariants,
    aliasName: $_aliasNameGenerator(db.items.id, db.itemVariants.itemId),
  );
  ...
  static MultiTypedResultKey<$RecipesTable, List<RecipeData>> _recipesRefsTable(
    _$AppDatabase db,
  ) => MultiTypedResultKey.fromTable(
    db.recipes,
    aliasName: $_aliasNameGenerator(db.items.id, db.recipes.itemId),
  );
...
typedef $$ZonesTableCreateCompanionBuilder =
    ZonesCompanion Function({Value<int> id, required String name});
typedef $$ZonesTableUpdateCompanionBuilder =
    ZonesCompanion Function({Value<int> id, Value<String> name});

final class $$ZonesTableReferences
    extends BaseReferences<_$AppDatabase, $ZonesTable, ZoneData> {
  $$ZonesTableReferences(super.$_db, super.$_table, super.$_typedResult);

  static MultiTypedResultKey<$RestaurantTablesTable, List<RestaurantTableData>>
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                Value<int> id = const Value.absent(),
                Value<String> name = const Value.absent(),
              }) => ZonesCompanion(id: id, name: name),
          createCompanionCallback:
              ({Value<int> id = const Value.absent(), required String name}) =>
                  ZonesCompanion.insert(id: id, name: name),
          withReferenceMapper: (p0) => p0
              .map(
                (e) =>
...
class $$RestaurantTablesTableTableManager
    extends
        RootTableManager<
          ...
          (RestaurantTableData, $$RestaurantTablesTableReferences),
          RestaurantTableData,
...
final class $$PaymentMethodsTableReferences
    extends
        BaseReferences<_$AppDatabase, $PaymentMethodsTable, PaymentMethodData> {
...
class $$PaymentMethodsTableTableManager
    extends
        RootTableManager<
          ...
          (PaymentMethodData, $$PaymentMethodsTableReferences),
          PaymentMethodData,
          PrefetchHooks Function({bool ordersRefs})
        > {
...
final class $$OrdersTableReferences
  ...
  static $PaymentMethodsTable _paymentMethodIdTable(_$AppDatabase db) =>
      db.paymentMethods.createAlias(
        $_aliasNameGenerator(db.orders.paymentMethodId, db.paymentMethods.id),
      );
...
final class $$ItemVariantsTableReferences
    extends BaseReferences<_$AppDatabase, $ItemVariantsTable, ItemVariantData> {
  ...
  static $ItemsTable _itemIdTable(_$AppDatabase db) => db.items.createAlias(
    $_aliasNameGenerator(db.itemVariants.itemId, db.items.id),
  );
  ...
  static MultiTypedResultKey<$RecipesTable, List<RecipeData>> _recipesRefsTable(
    ...
    db.recipes,
    aliasName: $_aliasNameGenerator(db.itemVariants.id, db.recipes.variantId),
  );
...
final class $$AddonsTableReferences
  ...
  static MultiTypedResultKey<$RecipesTable, List<RecipeData>> _recipesRefsTable(
    ...
    db.recipes,
    aliasName: $_aliasNameGenerator(db.addons.id, db.recipes.addonId),
  );
...
class $$AddonsTableTableManager
    extends
        RootTableManager<
          ...
          AddonData,
          PrefetchHooks Function({bool orderItemAddonsRefs, bool recipesRefs})
        > {
    ...
    : super(
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback:
              ({orderItemAddonsRefs = false, recipesRefs = false}) {
                return PrefetchHooks(
                  db: db,
                  explicitlyWatchedTables: [
                    if (orderItemAddonsRefs) db.orderItemAddons,
...
final class $$InventoryItemsTableReferences
  ...
  _purchaseInvoiceItemsRefsTable(_$AppDatabase db) =>
      MultiTypedResultKey.fromTable(
        ...
        aliasName: $_aliasNameGenerator(
          db.inventoryItems.id,
          db.purchaseInvoiceItems.inventoryItemId,
        ),
      );
  ...
  _inventoryTransactionsRefsTable(_$AppDatabase db) =>
      MultiTypedResultKey.fromTable(
        ...
        aliasName: $_aliasNameGenerator(
          db.inventoryItems.id,
          db.inventoryTransactions.inventoryItemId,
        ),
      );
...
final class $$RecipesTableReferences
  ...
  static $ItemsTable _itemIdTable(_$AppDatabase db) => db.items.createAlias(
    $_aliasNameGenerator(db.recipes.itemId, db.items.id),
  );
  ...
  static $ItemVariantsTable _variantIdTable(_$AppDatabase db) =>
      db.itemVariants.createAlias(
        $_aliasNameGenerator(db.recipes.variantId, db.itemVariants.id),
      );
  ...
  static $AddonsTable _addonIdTable(_$AppDatabase db) => db.addons.createAlias(
    $_aliasNameGenerator(db.recipes.addonId, db.addons.id),
  );
  ...
  static $InventoryItemsTable _inventoryItemIdTable(_$AppDatabase db) =>
      db.inventoryItems.createAlias(
        $_aliasNameGenerator(db.recipes.inventoryItemId, db.inventoryItems.id),
      );
...
final class $$SuppliersTableReferences
  ...
  static MultiTypedResultKey<$PurchaseInvoicesTable, List<PurchaseInvoiceData>>
  ...
  _purchaseInvoiceItemsRefsTable(_$AppDatabase db) =>
      MultiTypedResultKey.fromTable(
        ...
        aliasName: $_aliasNameGenerator(
          ...
          db.purchaseInvoiceItems.invoiceId,
        ),
      );
...
class $$PurchaseInvoicesTableFilterComposer
  ...
  ColumnWithTypeConverterFilters<DateTime, DateTime, String> get invoiceDate =>
      $composableBuilder(
...
class $$PurchaseInvoicesTableAnnotationComposer
  ...
  GeneratedColumnWithTypeConverter<DateTime, String> get invoiceDate =>
      $composableBuilder(
        column: $table.invoiceDate,
        builder: (column) => column,
      );
...
class $$PurchaseInvoicesTableTableManager
    extends
        RootTableManager<
          ...
          (PurchaseInvoiceData, $$PurchaseInvoicesTableReferences),
          PurchaseInvoiceData,
          PrefetchHooks Function({
            bool supplierId,
            bool purchaseInvoiceItemsRefs,
...
class $$PurchaseInvoiceItemsTableTableManager
    extends
        RootTableManager<
          ...
          (PurchaseInvoiceItemData, $$PurchaseInvoiceItemsTableReferences),
          PurchaseInvoiceItemData,
...
class $$InventoryTransactionsTableTableManager
    extends
        RootTableManager<
          ...
          (InventoryTransactionData, $$InventoryTransactionsTableReferences),
          InventoryTransactionData,
