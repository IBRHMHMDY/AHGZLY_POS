...
class CartItem implements CalculableItem {
  final ItemEntity item;
  final int quantity;
  final String? notes;
  CartItem({required this.item, required this.quantity, this.notes});
  ...
  @override
  int get itemPrice => item.price; // السعر من الصنف

  @override
  int get itemCost => item.cost; // تكلفة البضاعة (COGS) من الصنف
