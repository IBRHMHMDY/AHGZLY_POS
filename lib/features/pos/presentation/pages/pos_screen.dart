                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              TextButton.icon(
                                ...
                                onPressed: state.cartItems.isEmpty ? null : () => context.read<PosBloc>().add(ClearCartEvent()),
                              )
                            ],
                          ),
                        ),
                            ...
                            children: [
                              ...
                              ElevatedButton(
                                ...
                                onPressed: state.cartItems.isEmpty
                                    ? null
                                    : () async {
                                        final previousState = state; // حفظ نسخة من السلة قبل الدفع
                                        ...
                                        if (paymentMethod != null && context.mounted) {
                                          ...
                                          _showPrintDialog(context, 1001, previousState); 
                                        }
                                      },
