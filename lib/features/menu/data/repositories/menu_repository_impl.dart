...
class MenuRepositoryImpl implements MenuRepository {
  ...
  Future<Either<Failure, int>> addItem(ItemEntity item) async {
    try {
      final itemModel = ItemModel(
        categoryId: item.categoryId, name: item.name, price: item.price, cost: item.cost, imagePath: item.imagePath, createdAt: item.createdAt, updatedAt: item.updatedAt,
      );
  ...
  Future<Either<Failure, int>> updateItem(ItemEntity item) async {
    try {
      final itemModel = ItemModel(
        id: item.id, categoryId: item.categoryId, name: item.name, price: item.price, cost: item.cost, imagePath: item.imagePath, createdAt: item.createdAt, updatedAt: item.updatedAt,
      );
